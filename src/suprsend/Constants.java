...
public final class Constants {
	...
	public static final boolean ALLOW_ATTACHMENTS_IN_BULK_API = true;
	public static final boolean ATTACHMENT_UPLOAD_ENABLED = false;

	// Single Identity event limit
	public static final int IDENTITY_SINGLE_EVENT_MAX_APPARENT_SIZE_IN_BYTES = 10 * 1024;
	public static final String IDENTITY_SINGLE_EVENT_MAX_APPARENT_SIZE_IN_BYTES_READABLE = "10KB";
