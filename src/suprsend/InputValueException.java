...
public class InputValueException extends SuprsendException {
	...
	/**
	 * Constructs an {@code InputValueException} with {@code null} as its error detail
	 * message.
	 */
	...
	/**
	 * Constructs an {@code InputValueException} with the specified detail message and
	 * cause.
	 *
	 * <p>
	...
	/**
	 * Constructs an {@code InputValueException} with the specified cause and a detail
