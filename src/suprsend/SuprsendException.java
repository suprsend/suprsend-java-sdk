...
/**
 * Signals that an Suprsend exception of some sort has occurred. This
 * class is the general class of exceptions produced by failed or
 * interrupted Suprsend operations.
 *
 */
public class SuprsendException extends Exception {
	...
	/**
     * Constructs an {@code SuprsendException} with {@code null}
	...
	/**
     * Constructs an {@code SuprsendException} with the specified cause and a
